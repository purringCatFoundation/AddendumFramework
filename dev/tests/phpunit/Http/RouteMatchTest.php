...
class RouteMatchTest extends TestCase
{
    public function testConstructor(): void
    {
        ...
        $match = new RouteMatch('TestAction', [$middleware], $request, $policies);
    ...
    public function testMiddlewareAccess(): void
    {
        ...
        $match = new RouteMatch('TestAction', [$middleware], $request, $this->resourcePolicies());
    ...
    public function testResourcePoliciesAccess(): void
    {
        ...
        $match = new RouteMatch('TestAction', [], $request, $policies);
